    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->c1->setStyleSheet("QLabel{background:rgb(184,20,21);}");
    ui->c2->setStyleSheet("QLabel{background:rgb(184,20,21);}");
    ui->c3->setStyleSheet("QLabel{background:rgb(184,20,21);}");
    ui->c4->setStyleSheet("QLabel{background:rgb(184,20,21);}");
    ui->c5->setStyleSheet("QLabel{background:rgb(184,20,21);}");
    ui->c6->setStyleSheet("QLabel{background:rgb(184,20,21);}");
